...
{
    internal partial class TestCenterIncidentViewOnlySchemata : IModelSchemata<IncidentAttributes>
    {
        ...
        static TestCenterIncidentViewOnlySchemata()
        {
            var defaultSchema =
                BaseIncidentSchema.Create()
                    .Merge(TestCentreIncidentSchemata.WhenViewOnly.Create());
