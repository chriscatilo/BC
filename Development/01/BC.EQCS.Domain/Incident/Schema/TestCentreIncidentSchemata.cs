...
{
    internal partial class TestCentreIncidentSchemata : IModelSchemata<IncidentAttributes>
    {
        ...
        static TestCentreIncidentSchemata()
        {
            ...
            BuildForRaisingIncident(defaultSchema);
        ...
        private static void BuildForViewOnlyIncident(ModelSchema<IncidentAttributes> defaultSchema)
        {
            ...
            Schemata.Add(IncidentStatus.Submitted.ToString(), defaultSchema.Merge(WhenViewOnly.Create()));
            ...
            Schemata.Add(IncidentStatus.InProgress.ToString(), defaultSchema.Merge(WhenViewOnly.Create()));

            // Schema when incident is closed
            Schemata.Add(IncidentStatus.Closed.ToString(), defaultSchema.Merge(WhenViewOnly.Create()));
        }

        private static void BuildForRaisingIncident(ModelSchema<IncidentAttributes> defaultSchema)
        {
