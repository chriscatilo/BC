...
namespace BC.EQCS.UnitTests.Incident.Schemata
{
    ...
    public class VerificationSchemaWhenSavingCandidateOnDraftTest : IncidentSchemaBuildTest
    {
        private readonly IncidentCommand? _command;
        private readonly IncidentStatus? _currentStatus;

        public VerificationSchemaWhenSavingCandidateOnDraftTest(IncidentStatus? currentStatus, IncidentCommand? command)
        {
