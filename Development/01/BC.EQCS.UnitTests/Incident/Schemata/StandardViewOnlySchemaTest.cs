...
namespace BC.EQCS.UnitTests.Incident.Schemata
{
    ...
    // And incident is STANDARD VIEW ONLY form
    ...
    // And incident is STANDARD VIEW ONLY form
    public class StandardViewOnlySchemaTest : IncidentSchemaBuildTest
    {
        private readonly IncidentStatus _currentStatus;

        public StandardViewOnlySchemaTest(IncidentStatus currentStatus)
        {
        ...
        {
            return SchemaKey.StandardViewOnly;
        }
