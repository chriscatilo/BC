...
namespace BC.EQCS.UnitTests.Incident.Schemata
{
    ...
    // And incident is Standard With Sub Category form
    ...
    public class InvestigationSchemaWhenOpenOrOpeningTest : IncidentSchemaBuildTest
    {
        private readonly IncidentStatus? _currentStatus;
        private readonly IncidentCommand _command;

        public InvestigationSchemaWhenOpenOrOpeningTest(IncidentStatus? currentStatus, IncidentCommand command)
        {
