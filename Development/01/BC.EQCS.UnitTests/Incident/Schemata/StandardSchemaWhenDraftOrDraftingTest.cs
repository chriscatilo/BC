...
namespace BC.EQCS.UnitTests.Incident.Schemata
{
    ...
    // And incident is STANDARD form
    // And incident is being saved
    public class StandardSchemaWhenDraftOrDraftingTest : IncidentSchemaBuildTest
    {
        private readonly IncidentCommand? _command;
        private readonly IncidentStatus? _currentStatus;

        public StandardSchemaWhenDraftOrDraftingTest(IncidentStatus? currentStatus, IncidentCommand? command)
        {
