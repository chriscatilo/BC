...
{
    [TestFixture(IncidentStatus.Draft, IncidentCommand.AddCandidate)]
    // Given incident is Draft
    // And incident is STANDARD form
    // And incident candidate is being saved
    public class StandardSchemaWhenSavingCandidateOnDraftTest : IncidentSchemaBuildTest
    {
        private readonly IncidentCommand _command;
        private readonly IncidentStatus _currentStatus;

        public StandardSchemaWhenSavingCandidateOnDraftTest(IncidentStatus currentStatus, IncidentCommand command)
        {
