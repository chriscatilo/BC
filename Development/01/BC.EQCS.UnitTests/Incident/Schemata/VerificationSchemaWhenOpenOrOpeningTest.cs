...
namespace BC.EQCS.UnitTests.Incident.Schemata
{
    ...
    public class VerificationSchemaWhenOpenOrOpeningTest : IncidentSchemaBuildTest
    {
        private readonly IncidentCommand _command;
        private readonly IncidentStatus? _currentStatus;

        public VerificationSchemaWhenOpenOrOpeningTest(IncidentStatus? currentStatus, IncidentCommand command)
        {
