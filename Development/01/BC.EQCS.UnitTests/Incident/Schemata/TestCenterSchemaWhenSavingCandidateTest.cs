...
namespace BC.EQCS.UnitTests.Incident.Schemata
{
    ...
    // And incident is Test Center form
    // And incident candidate is being saved
    public class TestCenterSchemaWhenSavingCandidateTest : IncidentSchemaBuildTest
    {
        private readonly IncidentStatus? _currentStatus;
        private readonly IncidentCommand _incidentCommand;

        public TestCenterSchemaWhenSavingCandidateTest(IncidentStatus? currentStatus, IncidentCommand incidentCommand)
        {
