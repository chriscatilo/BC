...
namespace BC.EQCS.UnitTests.Incident.Schemata
{
    ...
    // And incident is Verfication with sub category field
    // And incident is being saved
    public class VerificationSchemaWhenDraftOrDraftingTest : IncidentSchemaBuildTest
    {
        private readonly IncidentCommand? _command;
        private readonly IncidentStatus? _currentStatus;

        public VerificationSchemaWhenDraftOrDraftingTest(IncidentStatus? currentStatus, IncidentCommand? command)
        {
