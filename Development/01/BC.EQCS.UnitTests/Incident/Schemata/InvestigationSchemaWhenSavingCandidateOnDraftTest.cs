...
namespace BC.EQCS.UnitTests.Incident.Schemata
{
    ...
    public class InvestigationSchemaWhenSavingCandidateOnDraftTest : IncidentSchemaBuildTest
    {
        private readonly IncidentCommand? _command;
        private readonly IncidentStatus? _currentStatus;

        public InvestigationSchemaWhenSavingCandidateOnDraftTest(IncidentStatus? currentStatus, IncidentCommand? command)
        {
