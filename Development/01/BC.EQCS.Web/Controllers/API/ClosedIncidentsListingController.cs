...
{
    public class ClosedIncidentsListingController : ODataController
    {
        ...
        public ClosedIncidentsListingController(IOdataRepository<IncidentsListingModel> incidentOdataRepository,
        ...
        // GET: odata/LiveIncidentsListing
        [Authorize]
        public async Task<IHttpActionResult> GetClosedIncidentsListing(ODataQueryOptions<IncidentsListingModel> queryOptions)
        {
            if (_authoriser.IsAuthorised(AssetType.IncidentViewListIncidents))
            {
                ...
                var itemsToreturn = ((IncidentListingODataRepository) _incidentOdataRepository)
                    .GetClosedIncidentsList(queryOptions, areas, categoriesThisUserCanView, _context.CurrentUser);
