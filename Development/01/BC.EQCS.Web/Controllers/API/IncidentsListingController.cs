...
{
    public class IncidentsListingController : ODataController
    {
        ...
        public IncidentsListingController(IOdataRepository<IncidentsListingModel> incidentOdataRepository,
        ...
        // GET: odata/IncidentsListing
        [Authorize]
        public async Task<IHttpActionResult> GetIncidentsListing(ODataQueryOptions<IncidentsListingModel> queryOptions)
        {
