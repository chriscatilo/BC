// source: https://github.com/DanWahlin/AngularOverlay
(function () {

    var wcOverlayDirective = function ($rootScope, $q, $timeout, $window, httpInterceptor, wcOverlayConfig) {
        return {
            restrict: 'EA',
            transclude: true,
            scope: {
    ...
    wcDirectivesApp.directive('wcOverlay', ['$rootScope', '$q', '$timeout', '$window', 'httpInterceptor', 'wcOverlayConfig', wcOverlayDirective]);
